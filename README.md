...
<body class="fondo-pagina">
   ...
   <form class="formulario-madre">
      ...
      <div class="email-login">
         ...
         <input class="email-input" type="text" placeholder="Enter Email" name="uname" required>
         <label class="password-palabra" for="psw"><b>Password</b></label>
         <input class="password-input" type="password" placeholder="Enter Password" name="psw" required>
      </div>
